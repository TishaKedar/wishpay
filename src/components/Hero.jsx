...
const Hero = () => {
  ...
  return (
    <section className="bg-white relative overflow-hidden">
      ...
      {/* Stats Section  */}
      <div className="container mx-auto px-6 lg:px-12 mt-2 sm:mt-0 flex flex-col md:flex-row items-center justify-between gap-8 sm:gap-6 mb-10 pb-6">
        <div className="text-center md:text-left">
          <p className="text-gray-500 text-sm sm:text-base text-center">Satisfied users <br /> globally</p>
          <p className="text-5xl sm:text-6xl font-bold-sm">75K+</p>
        </div>
        ...
        <div className="text-center md:text-right">
          ...
          <p className="text-5xl sm:text-6xl font-bold-sm">92%</p>
        </div>
      </div>
    </section>
  );
